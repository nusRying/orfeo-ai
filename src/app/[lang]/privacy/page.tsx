...
export default function PrivacyPage() {
  ...
  const sections = [
    dictionary.privacy.sections.collection,
    dictionary.privacy.sections.usage,
    dictionary.privacy.sections.sharing,
    dictionary.privacy.sections.retention,
    dictionary.privacy.sections.contact,
  ];
